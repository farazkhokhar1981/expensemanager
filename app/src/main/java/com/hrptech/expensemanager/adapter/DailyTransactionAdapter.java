...
public class DailyTransactionAdapter extends RecyclerView.Adapter<DailyTransactionAdapter.ViewHolder> {
    private Activity activity;
    private List<TransactionBeans> items;
    String search;
    public DailyTransactionAdapter(Activity activity, List<TransactionBeans> items, String search) {

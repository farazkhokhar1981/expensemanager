...
public class AppUpdateChecker {
    ...
    private class GetLatestVersion extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            double latestVersionDouble = 0;
            if(latestVersion!=null){
                latestVersionDouble = Double.parseDouble(latestVersion);
            }
            double currentVersionDouble = 0;
            if(currentVersion!=null){
                currentVersionDouble = Double.parseDouble(currentVersion);
            }
            if(latestVersionDouble>currentVersionDouble){
                ...
                builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //Click button action
                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.hrptech.dailyexampenseapp")));
                        dialog.dismiss();
                    }
                });
